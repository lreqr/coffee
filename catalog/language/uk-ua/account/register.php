...
// Heading
$_['heading_title']        = 'Створіть свій обліковий запис';

// Text
$_['text_account']         = 'Обліковий запис';
$_['text_register']        = 'Реєстрація';
$_['text_account_already'] = 'Наш учасник? <a href="%s">Вхід</a>';
$_['text_your_details']    = 'Ласкаво просимо у світ смаку та задоволення!';
