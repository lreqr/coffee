...
class __TwigTemplate_04c29512a678a2dac098cf7e74437787ccd0371fbbfe47afb477a0cfabee27d2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<ul class=\"languages list-inline m-0\">
  ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
                ...
                echo ">";
                echo twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 6), 1, 2);
                echo "</a></li>
  ";
            }
