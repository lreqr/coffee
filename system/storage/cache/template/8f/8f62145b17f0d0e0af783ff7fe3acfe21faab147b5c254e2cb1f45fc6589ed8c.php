...
class __TwigTemplate_766fb822a34d26251cabe3b4e61177a11148e3035977db69b46c83dbba94b270 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<main class=\"main product-page\">
    <div class=\"container\">
        ...
        echo "');\" class=\"btn btn-warning add-to-cart\">";
        ...
        <div class=\"row\">
            ...
            <div class=\"col-lg-4\">
                <div class=\"product-page-actions\">
                    ...
                    {% endif %}
                    <a  onclick=\"return cart.add('{{ product_id }}');\" class=\"btn btn-warning add-to-cart\">{{ button_cart }}</a>
                </div>
            </div>
        </div>
        <div class=\"row\">
