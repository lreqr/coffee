...
class __TwigTemplate_32631d06fb7d401ef57d295fd58608da33edf663a5740a849ab0d999ada7def9 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
            ...
            <div class=\"col-lg-4\">
                <div class=\"product-page-actions\">
                    ...
                    {% endif %}
                    <button id=\"button-cart\" onclick=\"return cart.add('{{ product.product_id }}');\" data-loading-text=\"{{ text_loading }}\" class=\"btn btn-warning add2cart-btn\">{{ button_cart }}</button>
                </div>
            </div>
        </div>
        <div class=\"row\">
