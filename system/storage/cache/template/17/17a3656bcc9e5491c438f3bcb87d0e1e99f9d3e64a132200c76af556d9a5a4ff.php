...
class __TwigTemplate_023e85a668e8af9dfad813a6bb1aea58b503a3d392a6b73b6d1a97be28e09584 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
            ...
            <div class=\"col-lg-4\">
                <div class=\"product-page-actions\">
                    ...
                    {% endif %}
                    <button id=\"button-cart\" data-loading-text=\"{{ text_loading }}\" class=\"btn btn-primary btn-lg btn-block\">{{ button_cart }}</button>
                </div>
            </div>
        </div>
        <div class=\"row\">
