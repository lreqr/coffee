...
class __TwigTemplate_f41f338081a1ee521ca778b3c7256e62c46702fbff38449f92de68e278dbc00b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
      <div id=\"content\" class=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            echo "\" class=\"\" onclick=\"cart.remove('";
            ...
            <table class=\"table table-bordered\">
              ...
              {% for product in products %}
                <tr>
                  ...
                  <button type=\"button\" data-toggle=\"tooltip\" title=\"{{ button_remove }}\" class=\"\" onclick=\"cart.remove('{{ product.cart_id }}');\"><span class=\"icon-trash\"></span></button>
                  </span></div></td>
