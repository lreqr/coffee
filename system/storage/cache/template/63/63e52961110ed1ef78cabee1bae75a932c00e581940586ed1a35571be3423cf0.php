...
class __TwigTemplate_36bd7816fab67a0348eb8fecc7e7dba356fb3a4c203c3b119500b633e7d9232e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 279
        echo twig_var_dump($this->env, $context, ...[0 => ($context["product"] ?? null)]);
    }
...
{{ footer }}
{{ dump(product) }}", "coffee/template/product/product.twig", "");
    }
}
