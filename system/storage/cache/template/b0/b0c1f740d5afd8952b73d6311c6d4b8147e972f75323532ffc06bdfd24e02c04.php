...
class __TwigTemplate_29b31c651bb602b8e43b7d3a287bd4ce78f45c6300cde45526f57873397ea779 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
            ...
            <div class=\"col-lg-4\">
                <div class=\"product-page-actions\">
                    ...
                    {% endif %}
                    <a  onclick=\"return cart.add('{{ product_id }}');\"  class=\"btn btn-warning add2cart-btn\">{{ button_cart }}</a>
                </div>
            </div>
        </div>
        <div class=\"row\">
