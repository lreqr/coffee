...
class __TwigTemplate_0d1dccfc2006a78beec25bc426afb675bca96802a24decb07db2c528f021f7eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<ul class=\"languages list-inline m-0\">
  ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
                ...
                echo ">";
                echo twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 6), 3, null);
                echo "</a></li>
  ";
            }
