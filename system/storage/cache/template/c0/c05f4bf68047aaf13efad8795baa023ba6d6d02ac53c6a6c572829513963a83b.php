...
class __TwigTemplate_a9df1351418f95bcd2f9c06dd80990860703893032189f34c0d2df9e8bc5cd8b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  60 => 11,  56 => 10,  48 => 7,  45 => 6,  43 => 5,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<!-- banner-section -->
<section class=\"banner-section\">
    <div class=\"container\">
        <div class=\"banner-section-inner\">
            {% set bannerText = banners[0].title|split('|') %}
            <div class=\"banner-section-img\">
                <img src=\"{{ banners[0].image }}\" alt=\"{{ bannerText[2] }}\">
            </div>
            <div class=\"banner-section-content\">
                <h2>{{ bannerText[0] }}</h2>
                <p>{{ bannerText[1] }}</p>
