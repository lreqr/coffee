...
class __TwigTemplate_c32fff9812f8f45b85e75b99a4dab83fc828a3dfd39954fbb3d5c3f3c0be60b2 extends \Twig\Template
{
    private $source;
    private $macros = [];
                            ...
                            {% if text_agree %}
                                <div class=\"buttons\">
                                    <div class=\"pull-right\">{{ text_agree }}
                                        ...
                                        {% endif %}
                                        &nbsp;
                                        <input class=\"form-check-input\" type=\"submit\" value=\"{{ button_continue }}\" class=\"btn btn-primary\"/>
                                    </div>
                                </div>
                            {% else %}
                                <div class=\"buttons\">
