...
class __TwigTemplate_15ac740c03b18c682c435968c97f6a2c91a3fcdf0a6e704ded9ec4ec1e3801d3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"offcanvas-body\">
        ...
        if ((($context["products"] ?? null) || ($context["vouchers"] ?? null))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "\" data-size=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 31);
                    ...
                    <div class=\"mini-cart-product-row\">
                        ...
                        <div class=\"mini-cart-product-info\">
                            ...
                            <p class=\"product-qty\"><input type=\"number\" value=\"{{ product.quantity }}\" data-qty=\"{{ product.quantity }}\"
                                                          data-id=\"{{ product.product_id }}\" data-size=\"{{ product.option }}\" min=\"1\" max=\"100\"> &times; {{ product.total }}
                            </p>
                        </div>
