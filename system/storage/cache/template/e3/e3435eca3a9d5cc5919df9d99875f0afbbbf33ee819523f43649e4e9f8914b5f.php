...
class __TwigTemplate_503edae3ec52abb7a05743dbf86eb2178aa618cfec7a7688403f62849ee63ffd extends \Twig\Template
{
    private $source;
    private $macros = [];
          ...
          <div class=\"table-responsive\">
            <table class=\"table table-bordered\">
              ...
              {% for product in products %}
                <tr>
                  <td class=\"text-center\">{% if product.thumb %} <a class=\"active\" href=\"{{ product.href }}\"><img src=\"{{ product.thumb }}\" alt=\"{{ product.name }}\" title=\"{{ product.name }}\" class=\"img-thumbnail\" /></a> {% endif %}</td>
