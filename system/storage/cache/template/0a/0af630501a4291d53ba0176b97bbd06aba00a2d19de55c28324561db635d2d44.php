...
class __TwigTemplate_1ade3b66f68895591f32765844e8185cf87eed73d6528abac2e8b0f37e41e900 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
            ...
            <div class=\"col-lg-4\">
                <div class=\"product-page-actions\">
                    ...
                    {% endif %}
                    <a  onclick=\"return cart.add('{{ product_id }}');\" class=\"btn btn-warning \">{{ button_cart }}</a>
                </div>
            </div>
        </div>
        <div class=\"row\">
