...
class __TwigTemplate_f1800a339630560b966fa2262f1ca87892bda9064c8b839fcf3b8256d399cb9b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"offcanvas-body\">
        ...
        if ((($context["products"] ?? null) || ($context["vouchers"] ?? null))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "\" data-size=\"";
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 31), "value", [], "any", false, false, false, 31);
                    ...
                    <div class=\"mini-cart-product-row\">
                        ...
                        <div class=\"mini-cart-product-info\">
                            ...
                            <p class=\"product-qty\"><input type=\"number\" value=\"{{ product.quantity }}\" data-qty=\"{{ product.quantity }}\"
                                                          data-id=\"{{ product.product_id }}\" data-size=\"{{ product.option.value }}\" min=\"1\" max=\"100\"> &times; {{ product.total }}
                            </p>
                        </div>
