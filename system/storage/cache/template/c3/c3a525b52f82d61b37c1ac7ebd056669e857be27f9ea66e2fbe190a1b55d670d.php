...
class __TwigTemplate_5f10d9d1879d93bcbe23873cbba6e79da774378eb0e8824a8ba0c1faeec1333d extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
            ...
            <div class=\"col-lg-4\">
                <div class=\"product-page-actions\">
                    ...
                    {% endif %}
                    <button id=\"button-cart\" onclick=\"return cart.add('{{ special }}');\" data-loading-text=\"{{ text_loading }}\" class=\"btn btn-warning add2cart-btn\">{{ button_cart }}</button>
                </div>
            </div>
        </div>
        <div class=\"row\">
