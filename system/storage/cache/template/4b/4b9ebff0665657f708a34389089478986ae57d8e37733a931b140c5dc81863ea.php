...
class __TwigTemplate_87a00d4b6425fa2e2f7ffe876353c27102bc11c75bbfdb4bc74b16953526b325 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
            ...
            <div class=\"col-lg-4\">
                <div class=\"product-page-actions\">
                    ...
                    {% endif %}
                    <a href=\"\" onclick=\"return cart.add('{{ product_id }}');\" class=\"add-to-cart\">{{ button_cart }}</a>
                </div>
            </div>
        </div>
        <div class=\"row\">
